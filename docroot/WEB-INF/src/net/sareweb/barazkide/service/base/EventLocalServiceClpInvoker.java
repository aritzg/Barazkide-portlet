...
public class EventLocalServiceClpInvoker {
	public EventLocalServiceClpInvoker() {
		...
		_methodParameterTypes15 = new String[] {
				"net.sareweb.barazkide.model.Event", "boolean"
			};
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return EventLocalServiceUtil.addEvent((net.sareweb.barazkide.model.Event)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return EventLocalServiceUtil.deleteEvent((net.sareweb.barazkide.model.Event)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return EventLocalServiceUtil.updateEvent((net.sareweb.barazkide.model.Event)arguments[0]);
		}
