...
/**
 * The base implementation of the following remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.barazkide.service.impl.FollowingServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 * @see net.sareweb.barazkide.service.impl.FollowingServiceImpl
 * @see net.sareweb.barazkide.service.FollowingServiceUtil
 * @generated
 */
public abstract class FollowingServiceBaseImpl extends BaseServiceImpl
	implements FollowingService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.barazkide.service.FollowingServiceUtil} to access the following remote service.
	 */
	...
	private FollowingServiceClpInvoker _clpInvoker = new FollowingServiceClpInvoker();
}