...
/**
 * The base implementation of the rating local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.barazkide.service.impl.RatingLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 * @see net.sareweb.barazkide.service.impl.RatingLocalServiceImpl
...
public abstract class RatingLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.barazkide.service.RatingLocalServiceUtil} to access the rating local service.
	 */
	...
	public Rating addRating(Rating rating) throws SystemException {
		...
		return ratingPersistence.update(rating, false);
	}
	...
	public Rating updateRating(Rating rating) throws SystemException {
		return updateRating(rating, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Rating updateRating(Rating rating, boolean merge)
		throws SystemException {
		rating.setNew(false);

		return ratingPersistence.update(rating, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.barazkide.model.Rating",
			ratingLocalService);
	}
