...
/**
 * The base implementation of the garden local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.barazkide.service.impl.GardenLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 * @see net.sareweb.barazkide.service.impl.GardenLocalServiceImpl
 * @see net.sareweb.barazkide.service.GardenLocalServiceUtil
 * @generated
 */
public abstract class GardenLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GardenLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.barazkide.service.GardenLocalServiceUtil} to access the garden local service.
	 */
	 ...
	 */
	public Garden createGarden(long gardenId) {
		return gardenPersistence.create(gardenId);
	}

	/**
	 * Deletes the garden with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param gardenId the primary key of the garden
	 * @return the garden that was removed
	 * @throws PortalException if a garden with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public Garden deleteGarden(long gardenId)
		throws PortalException, SystemException {
		return gardenPersistence.remove(gardenId);
	}

	/**
	 * Deletes the garden from the database. Also notifies the appropriate model listeners.
	 *
	 * @param garden the garden
	 * @return the garden that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public Garden deleteGarden(Garden garden) throws SystemException {
		return gardenPersistence.remove(garden);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Garden.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return gardenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return gardenPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return gardenPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Garden fetchGarden(long gardenId) throws SystemException {
		return gardenPersistence.fetchByPrimaryKey(gardenId);
	}

	/**
	 * Returns the garden with the primary key.
	 *
	 * @param gardenId the primary key of the garden
	 * @return the garden
	 * @throws PortalException if a garden with the primary key could not be found
	...
	public Garden getGarden(long gardenId)
		throws PortalException, SystemException {
		return gardenPersistence.findByPrimaryKey(gardenId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return gardenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Garden> getGardens(int start, int end)
		throws SystemException {
		return gardenPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getGardensCount() throws SystemException {
		return gardenPersistence.countAll();
	}

	/**
	 * Updates the garden in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param garden the garden
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Garden updateGarden(Garden garden) throws SystemException {
		return updateGarden(garden, true);
	}
	 ...
	 *
	 * @param garden the garden
	 * @param merge whether to merge the garden with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the garden that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Garden updateGarden(Garden garden, boolean merge)
		throws SystemException {
		garden.setNew(false);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.barazkide.model.Garden",
			gardenLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = gardenPersistence.getDataSource();
	...
	private GardenLocalServiceClpInvoker _clpInvoker = new GardenLocalServiceClpInvoker();
}