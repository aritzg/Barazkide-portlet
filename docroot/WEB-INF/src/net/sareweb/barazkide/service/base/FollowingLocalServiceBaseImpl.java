...
/**
 * The base implementation of the following local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.barazkide.service.impl.FollowingLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 * @see net.sareweb.barazkide.service.impl.FollowingLocalServiceImpl
 * @see net.sareweb.barazkide.service.FollowingLocalServiceUtil
 * @generated
 */
public abstract class FollowingLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FollowingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.barazkide.service.FollowingLocalServiceUtil} to access the following local service.
	 */

	/**
	 * Adds the following to the database. Also notifies the appropriate model listeners.
	 *
	 * @param following the following
	 * @return the following that was added
	...
	public Following addFollowing(Following following)
		...
		return followingPersistence.update(following, false);
	}
	 ...
	 */
	public Following createFollowing(long followingId) {
		return followingPersistence.create(followingId);
	}

	/**
	 * Deletes the following with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param followingId the primary key of the following
	 * @return the following that was removed
	 * @throws PortalException if a following with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public Following deleteFollowing(long followingId)
		throws PortalException, SystemException {
		return followingPersistence.remove(followingId);
	}

	/**
	 * Deletes the following from the database. Also notifies the appropriate model listeners.
	 *
	 * @param following the following
	 * @return the following that was removed
	 * @throws SystemException if a system exception occurred
	...
	public Following deleteFollowing(Following following)
		throws SystemException {
		return followingPersistence.remove(following);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Following.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return followingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return followingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return followingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Following fetchFollowing(long followingId) throws SystemException {
		return followingPersistence.fetchByPrimaryKey(followingId);
	}

	/**
	 * Returns the following with the primary key.
	 *
	 * @param followingId the primary key of the following
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Following getFollowing(long followingId)
		throws PortalException, SystemException {
		return followingPersistence.findByPrimaryKey(followingId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return followingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Following> getFollowings(int start, int end)
		throws SystemException {
		return followingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFollowingsCount() throws SystemException {
		return followingPersistence.countAll();
	}

	/**
	 * Updates the following in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param following the following
	 * @return the following that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Following updateFollowing(Following following)
		throws SystemException {
		return updateFollowing(following, true);
	}
	 ...
	 *
	 * @param following the following
	 * @param merge whether to merge the following with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the following that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Following updateFollowing(Following following, boolean merge)
		throws SystemException {
		following.setNew(false);

		return followingPersistence.update(following, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.barazkide.model.Following",
			followingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = followingPersistence.getDataSource();
	...
	private FollowingLocalServiceClpInvoker _clpInvoker = new FollowingLocalServiceClpInvoker();
}